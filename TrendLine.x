//xlang Source, Name:TrendLine.x 
//Date: Sun Jul 00:23:36 2025 

class TrendLine : DrawObject {
    int step = -1;
    ...
    public TrendLine() {
        ...
        String szConf = Preference.getString("trline");
    ...
    public void updateConfigure()override{
        ...
        if (savedef){
            ...
            if (result != nilptr){
                Preference.setSetting("trline", result.toString(false));
            }
        }
    }
